...
class Float8Test extends NumericTest
{
    ...
    {
        $this->assertIsFloat($this->makeInstance()->parseLiteral(new IntValueNode(['value' => 2])));
        $this->assertIsFloat($this->makeInstance()->parseLiteral(new FloatValueNode(['value' => 2.0])));
    }
