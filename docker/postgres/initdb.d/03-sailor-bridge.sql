CREATE DATABASE sailor_bridge;
\c sailor_bridge;

-- Copyright: https://raw.githubusercontent.com/hasura/template-gallery/main/postgres/permissions-extensible-attributes-jsonb/migration.sql
